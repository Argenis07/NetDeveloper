<%@ Page Title="" Language="C#" MasterPageFile="~/Site/MantTemplate.Master" AutoEventWireup="true" CodeBehind="ListaArtist.aspx.cs" Inherits="WebForms.Test.Site.ArtistWeb.ListaArtist" %>
...
<asp:Content ID="ListContent" ContentPlaceHolderID="ArtistContent" runat="server">
    ...
    <div>
        ...
        <asp:Button ID="btnprev" runat="server" Text="Anterior Registro" OnClick="btnprev_Click" />
